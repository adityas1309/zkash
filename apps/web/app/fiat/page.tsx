  ...
  return (
    <main className="p-4 md:p-8 max-w-5xl mx-auto space-y-12">
      ...
      <div className="text-center space-y-4 max-w-2xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-white">Fiat Ramp</h1>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-slate-900/40 p-6 rounded-2xl border border-slate-800/50 hover:border-indigo-500/30 transition-all hover:bg-slate-900/60 group relative overflow-hidden">
            ...
            <p className="text-slate-400 text-sm leading-relaxed relative z-10">
              Razorpay is in Test Mode active. You can use any mock card details
              or UPI ID. No real money will be deducted.
            </p>
          </div>
        </div>
      </div>
