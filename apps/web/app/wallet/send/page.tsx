    ...
    <div className="max-w-xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        ...
        <Badge variant={isPrivate ? 'success' : 'warning'}>
          {isPrivate ? (
            <span className="flex items-center gap-1"><Shield size={12} /> Private (ZK)</span>
          ) : (
        ...
        <div className="space-y-6">
          <div className="p-4 rounded-lg bg-slate-800/30 border border-slate-700/50 flex items-start gap-3">
            ...
            <p className="text-sm text-slate-300">
              You are sending in <span className={isPrivate ? "text-indigo-400 font-bold" : "text-blue-400 font-bold"}>
          ...
          <div>
            <label className="block text-slate-400 text-sm font-medium mb-2">Recipient</label>
            <Input
              type="text"
              value={recipient}
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="col-span-1">
              <label className="block text-slate-400 text-sm font-medium mb-2">Asset</label>
              <select
                value={asset}
      ...
      {status && (
        <Card variant={status.includes('success') || status.includes('submitted') ? 'default' : 'neon'} className="p-4 border-l-4 border-l-indigo-500">
