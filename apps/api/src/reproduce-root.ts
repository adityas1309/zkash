...
async function main() {
    ...
    console.log(`Expected (On-Chain): 45e2e6d5a6459e1a769c58edb916ed89a93a5ea13e40f00a8c1be4a3013e8b01`);
    ...
    if (Buffer.from(r).toString('hex') === '45e2e6d5a6459e1a769c58edb916ed89a93a5ea13e40f00a8c1be4a3013e8b01') console.log('MATCH!');
